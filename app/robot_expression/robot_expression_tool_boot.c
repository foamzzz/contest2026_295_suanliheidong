...
static char *robot_expression_tool_get_tools(void)
{
  static const char tools_json[] =
    ...
    "\"description\":\"Set the robot dog's visible facial expression. "
    "The selected expression remains active until this tool is called again "
    "with a different expression. Use it when a visible emotional reaction "
    "adds value; do not call it for every response.\","
    "\"input_schema\":{\"type\":\"object\",\"properties\":{"
    "\"expression\":{\"type\":\"string\",\"enum\":["
    "\"idle\",\"listening\",\"thinking\",\"happy\","
    "\"speaking\",\"error\"]}},\"required\":[\"expression\"]}}]";
                                         ...
                                         size_t output_size)
{
  ...
  /*
   * Do not require robot_expression_is_available() to already be true here.
   * The OLED worker initializes asynchronously; a successful queue submission
   * is enough for the Tool call to succeed.
   */
  snprintf(output, output_size,

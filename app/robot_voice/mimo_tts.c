 ...
 * byte.  Only PCM16LE / 24 kHz / mono is accepted.
 *
 * This replaces mimo_stream_wav_base64() for the TTS path.  A malformed or
 * truncated WAV now fails before partial/corrupted PCM reaches the speaker.
 */
